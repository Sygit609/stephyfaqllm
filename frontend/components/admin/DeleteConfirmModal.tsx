 ...
 * Warns user before deleting content item, especially if it's a parent with children
 */
...
export default function DeleteConfirmModal({
  ...
  const isParent = !item.parent_id && childrenCount > 0
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-800">
                      This will also delete <strong>{childrenCount} child item{childrenCount !== 1 ? 's' : ''}</strong> linked to this parent.
                    </p>
                  </div>
                </div>
              </div>
